...
<head>
    ...
    <link rel="stylesheet" href="<?php echo "/". explode('/', $_SERVER['PHP_SELF'])[1]. "/views/assets/css/accountant/{$css}" ?>" type="text/css">
    ...
    <script defer src="/<?php echo explode('/', $_SERVER['PHP_SELF'])[1]. "/assets/js/accountant/{$js}"?>"></script>
</head>
<?php $this->end(); ?>