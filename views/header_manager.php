<?php $this->section('header_manager'); ?>
<head>
    <meta charset="UTF-8" />
    ...
    <link rel="stylesheet" href="<?php echo "/". explode('/', $_SERVER['PHP_SELF'])[1]. "/views/assets/css/manager/{$css}" ?>" type="text/css">
    ...
    <script defer src="/<?php echo explode('/', $_SERVER['PHP_SELF'])[1]. "/assets/js/manager/{$js}"?>"></script>
