...
<form action="" method="post">
    <div class="tabs">
        <input class="input" name="tabs" type="radio" value="tab-1" id="tab-1" checked="checked" />
        ...
        <?php if (isset( $_POST['tabs']) && $_POST['tabs'] == "tab-2") : ?> checked <?php endif; ?>/>
        ...
        <?php if (isset( $_POST['tabs']) && $_POST['tabs'] == "tab-3") : ?> checked <?php endif; ?>/>
