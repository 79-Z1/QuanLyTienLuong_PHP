...
<form action="" method="post">
    <div class="tabs">
        <input class="input" name="tabs" type="radio" value="tab-4" id="tab-4" checked="checked" />
        ...
        <input class="input" name="tabs" type="radio" value="tab-2" id="tab-2" <?php if (isset($_POST['tabs']) && $_POST['tabs'] == "tab-2") : ?> checked <?php endif; ?> />
