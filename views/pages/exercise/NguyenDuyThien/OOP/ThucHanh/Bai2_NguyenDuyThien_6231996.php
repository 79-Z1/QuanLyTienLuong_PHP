...
<body>
    ...
    if(isset($_POST['xuli'])){
        if(!empty($_POST['hoten']) && !empty($_POST['socon']) && !empty($_POST['ngaysinh'])&& !empty($_POST['ngayvaolam']) && !empty($_POST['hesoluong'])){
            if($_POST['radLNV'] == 'VanPhong'){
                ...
                else "vui lòng nhập số con và hệ số lương là số";
            }
            else{
        ...
        <table>
            ...
            <tr>
                <td colspan="4" align="center">
                    <input type="submit" value="Tính" name="xuli" />
                </td>
            </tr>
            <tr>
                <td>Tiền lương:</td>
