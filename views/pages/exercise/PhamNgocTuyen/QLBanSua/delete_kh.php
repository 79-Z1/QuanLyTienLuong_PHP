...
if (isset($_POST['xoa'])) {
   ...
   where Ma_khach_hang = '$_GET[Ma_khach_hang]'";
...
<table>
    ...
    <tr>
        ...
        <tr><td >Giới tính: </td>
        <td>
            <input type="radio" name="radGT" value="1" <?php if (isset($_POST['radGT']) && $_POST['radGT'] == '0' || $kh['Phai']=='0') echo 'checked="checked" '; ?>disabled="disabled" checked />
            Nam
            <input type="radio" name="radGT" value="0" <?php if (isset($_POST['radGT']) && $_POST['radGT'] == '1' || $kh['Phai']=='1') echo 'checked="checked"'; ?> disabled="disabled"/>
            Nữ
        </td>
        </tr>
    </tr>
    <tr>
        ...
        <tr>
        <td >Số điện thoại: </td>
            <td><input type="text" name="sdt" value="<?php  echo $sdt;?> "disabled="disabled"/></td>
        </tr>
    </tr>
    <tr>
        <td>Địa chỉ:</td>
        <td><input type="text" name="dc" size="30" value="<?php  echo $dc;?> "disabled="disabled"/></td>
    <tr>    
        <td>Email:</td>
        <td><input type="text" name="em" value="<?php  echo $em;?> "disabled="disabled"/></td>
        </tr>
    </tr>
    <tr>
                        <td id="no_color" colspan="4" align="center">
                        <input type="submit" value="Xóa" name="xoa" class="btn btn-outline-purple xoakh-btn mb-5 w-25"/>
                        </td>
                    </tr>
</table>
</form>
