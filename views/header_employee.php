...
<head>
    ...
    <link rel="stylesheet" href=<?php echo "/". explode('/', $_SERVER['PHP_SELF'])[1] ."/assets/css/main_nhanvien.css"?> type="text/css" />
    <link rel="stylesheet" href="<?php echo "/". explode('/', $_SERVER['PHP_SELF'])[1]. "/assets/css/{$css}" ?>" type="text/css">
    ...
    <script defer src="/<?php echo explode('/', $_SERVER['PHP_SELF'])[1]. "/assets/js/{$js}"?>"></script>
</head>
<?php $this->end(); ?>